...
achieves \textbf{0.86 F1} on breaking-change detection, \textbf{1.00}
expand-contract compliance, and \textbf{0.97} plan completeness, outperforming
...
\begin{enumerate}[leftmargin=*,itemsep=1pt,topsep=2pt]
  ...
  \item \textbf{Empirical evaluation.} CARA achieves 0.86 F1 and 0.80 overall
...
\midrule
Adapter Generation Rate   & \textbf{0.88} & N/A  & 0.00 \\
...
\addplot[fill=darkgray!80, draw=darkgray] coordinates {
  (F1,0.86) (Completeness,0.97) (Expand-Ctr,1.00) (Pass Rate,0.80)};
...
in four languages. On our 15-case benchmark, CARA achieves 0.86 F1 and
